...
public class CalculatingCgpaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculating_cgpa);
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            Toast.makeText(CalculatingCgpaActivity.this,"Please Enter all the information",Toast.LENGTH_SHORT).show();
        }
